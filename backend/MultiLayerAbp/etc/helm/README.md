...
```
127.0.0.1 multilayerabp-local-web
127.0.0.1 multilayerabp-local-webgateway
127.0.0.1 multilayerabp-local-authserver
```
...
Now, you can browse the URL: `https://multilayerabp-local-web`
