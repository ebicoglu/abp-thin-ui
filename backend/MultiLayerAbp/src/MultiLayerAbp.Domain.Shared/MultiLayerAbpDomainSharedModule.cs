...
public class MultiLayerAbpDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        MultiLayerAbpGlobalFeatureConfigurator.Configure();
        MultiLayerAbpModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<MultiLayerAbpDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<MultiLayerAbpResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/MultiLayerAbp");

            options.DefaultResourceType = typeof(MultiLayerAbpResource);
        ...
        {
            options.MapCodeNamespace("MultiLayerAbp", typeof(MultiLayerAbpResource));
        });
    }
}
