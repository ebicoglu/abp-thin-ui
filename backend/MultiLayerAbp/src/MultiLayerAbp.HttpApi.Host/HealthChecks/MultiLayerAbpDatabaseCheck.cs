...
public class MultiLayerAbpDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public MultiLayerAbpDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
